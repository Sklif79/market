...
$(document).ready(function () {
    ...
    //установка по умолчанию табличного вида
    // if ($('.sorting-catalog-view').length) {
    //     var target = $('.sorting-catalog-view').find('a.line');
    //     var timerId = setInterval(function () {
    //         target.trigger('click');
    //
    //         if (target.hasClass('active')) {
    //             clearInterval(timerId);
    //             $('#product_cont').css({'opacity':'1'});
    //         }
    //
    //     },100);
    // }
    ...
    // $('#cartInner, .basket-under-header').on({
    //     mouseenter: function () {
    //         leaveBasket = false;
    //         $('.basket-under-header').addClass('active');
    //     },
    ...
    //блок товаров в корзине в header
    // function inBasketHeader() {
    //     var basket = $('.basket-under-header');
    //     // basket.remove();
    //
    //     setTimeout(function () {
    //         $('.header.has-basket').after(basket);
    //     }, 1000);
    //     // $('.header.has-basket').append(basket);
    // }
    //
    // inBasketHeader();
    ...
    //blockqoute
    // $('blockquote').append('<img src="assets/templates/market/img/update/quote-left.svg" class="svg">');
    ...
    function descriptionTableMaxHeight() {
        if ($('.card-description__table').length) {
            ...
            $('.card-description__table-wrap').css({'max-height': maxHeight + 1 + 'px'});
        }
    }
